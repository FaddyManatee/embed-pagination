...
class Paginator(discord.ui.View):
    ...
    initial_page: int
        The (zero-based) page number to start the paginator on.
    allow_others: bool
        Allow others to interact with the paginator, even if they did not execute it.
    delete_on_timeout: bool
        Deletes the paginator when timeout occurs when set to true.
    """
